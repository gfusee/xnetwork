...
echo "Duplicating db into import-db for validator01..."
cp -R /home/ubuntu/testnet/validator01/db/. /home/ubuntu/testnet/validator01/import-db/db/
...
echo "Duplicating db into import-db for validator02..."
cp -R /home/ubuntu/testnet/validator02/db/. /home/ubuntu/testnet/validator02/import-db/db/
...
echo "Duplicating db into import-db for validator03..."
cp -R /home/ubuntu/testnet/validator03/db/. /home/ubuntu/testnet/validator03/import-db/db/
